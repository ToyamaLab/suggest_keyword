...
if(isset($word)){
  echo "<select name=\"category_popup\">";
    if($category_popup == "Thing"){
        $word = str_replace("_", " ", $word);
        $command="/home/toyama/yuna/local/python/bin/python3 test_3.py \"" . $word . "\"";
    ...
    $command="/home/toyama/yuna/local/python/bin/python3 test_4.py \"" . $comma_separated_popup . "\" \"" . $category_popup."\"";
